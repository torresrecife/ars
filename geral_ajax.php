...
while($Wsel = mysqli_fetch_array($Qsel)){
	...
	for($m=1;$m<=$ncol;$m++){
		if( (($m==1 || $m==4 || $m==7 || $m==10) && $ncol==12) ||
			...
			if( (($m==2 || $m==5 || $m==8 || $m==11) && $ncol==12) ||
				...
				$html_1 .= "<td class='cls_body' align='center'><img src='http://***REMOVED***/img/$bol' class='box' />" . $resul . " %</td>";
			}
		}
	}
	$col_2=0;
	...
	$html_1 .= "<td class='cls_body cls_bk' align='center' style='color:#000'><img src='http://***REMOVED***/img/$cor' class='box' />".number_format(($mt_mes!=0?($tt/($mt_mes)):0)*100,0,',','')." %</td>";
	...
	if($Wrow==$lin){
				...
				(($m==1 || $m==4 || $m==7 || $m==10 || $m==13) && $ncol==15) ){	
					...
					$html_1 .= "<td align='center' class='cls_vals2 cls_bk' ><b>".number_format(${"R_".$m},2,',','.')."</b></td>";
					 ...
					 (($m==3 || $m==6 || $m==9 || $m==12 || $m==15)  && $ncol==15) ){
						...
						$html_1 .= "<td align='center' class='cls_vals2 cls_bk'><img src='http://***REMOVED***/img/$Tbol' class='box' /><b>".$Tp." %</b></td>";
			}
		}
		...
		$html_1 .= "<td align='center' class='cls_vals2 cls_bk' ><img src='http://***REMOVED***/img/$Mbol' class='box' /><b>".$mt." %</td>";
		$html_1 .= "</tr>";
