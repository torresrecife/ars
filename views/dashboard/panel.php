...
<table align='center' height='20%' width='100%' border='0' cellspacing='1' cellpadding='1' id='tb_fim' style='font-family:Tahoma;font-size:8pt; border-collapse: collapse;'>
	...
	<tr>
		...
		<?php foreach ($summary['weekTotals'] as $weekTotal): ?>
			...
			<td align='center' class='cls_vals2 cls_bk'><img src='http://***REMOVED***/img/<?php echo $weekTotal['icon']; ?>' class='box' />&nbsp;<b><?php echo number_format($weekTotal['percent'], 1, ',', ''); ?>%</b></td>
		<?php endforeach; ?>
		...
		<td align='center' class='cls_vals2 cls_bk'><img src='http://***REMOVED***/img/<?php echo $summary['grandIcon']; ?>' class='box' />&nbsp;<b><?php echo number_format($summary['grandPercent'], 1, ',', ''); ?>%</b></td>
	</tr>
	<tr height='5px'></tr>
...
<table align='center' height='6%' width='25%' border='1' cellspacing='3' cellpadding='3' id='tb_tot' style='font-family:arial;font-size:8pt; border-collapse: collapse;'>
	<tr>
		...
		<td align='center' style='background:#ffffff'><img src='http://***REMOVED***/img/<?php echo $summary['netIcon']; ?>' class='box' /><?php echo number_format($summary['netPercent'], 1, ',', ''); ?>%</td>
	</tr>
</table>
<br><br><br><br>
<script>
