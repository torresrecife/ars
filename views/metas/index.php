...
?>
<?php echo "<br><div style='font-family:arial;margin-left:40px;font-size:10pt;'>Cliente: <b>" . $bankCode . "</b> | MÃƒÂªs / Ano: <b>$startDate</b></div><br>"; ?>
...
<table class="***REMOVED***list" style="width:60%">
	<tr height="30">
		...
		<td class="order"><b>OpÃƒÂ§ÃƒÂµes</b></td>
	</tr>
<?php foreach ($metas as $arr): ?>
	...
	<tr>
		...
		<td class="order" style="color:#ffffff;background:<?php echo ((int) $arr['especie'] === 1 ? '#1C86EE' : '#FFB90F'); ?>"><?php echo $metaTipos[$arr['especie']]; ?></td>
...
<div id="dialog-edit-metas" title="Editar UsuÃƒÂ¡rio" style="display:none; text-align:left;">
							...
							<div style="float:left">
								<select class="cls_metas2 input-default" name="meta_name_1" id="meta_name_1" obrigatorio="1" title="Setor" onchange="my_especie(1);" style="width:260px;height:22px;">
									...
									<?php foreach ($andamentos as $andamento): ?>
										<option value="<?php echo $andamento['anda_id']; ?>" especie="<?php echo $andamento['especie']; ?>"><?php echo $andamento['nome'] . ' (' . $metaTipos[$andamento['especie']] . ')'; ?></option>
									<?php endforeach; ?>
								</select>
								...
								<input type="text" class="cls_meta sem_1" name="sem1_valor_1" id="sem1_valor_1" value="" title="Valor da 1Ã‚Âª semana" onkeypress="somarMeta(1)" onblur="somarMeta(1)" style="display:none;width:70px;">
								<input type="text" class="cls_meta sem_1" name="sem2_valor_1" id="sem2_valor_1" value="" title="Valor da 2Ã‚Âª semana" onkeypress="somarMeta(1)" onblur="somarMeta(1)" style="display:none;width:70px;">
								<input type="text" class="cls_meta sem_1" name="sem3_valor_1" id="sem3_valor_1" value="" title="Valor da 3Ã‚Âª semana" onkeypress="somarMeta(1)" onblur="somarMeta(1)" style="display:none;width:70px;">
								<input type="text" class="cls_meta sem_1" name="sem4_valor_1" id="sem4_valor_1" value="" title="Valor da 4Ã‚Âª semana" onkeypress="somarMeta(1)" onblur="somarMeta(1)" style="display:none;width:70px;">
								<input type="text" class="cls_meta sem_1" name="sem5_valor_1" id="sem5_valor_1" value="" title="Valor da 5Ã‚Âª semana" onkeypress="somarMeta(1)" onblur="somarMeta(1)" style="display:none;width:70px;">
