...
<table class="adminlist">
	<tr height="30">
		...
		<td class="order"><b>Configurações</b></td>
	</tr>
		...
		<div>
			<table style="width:400px">
				...
				<tr>
					...
					<td align="center" style="width:50px">à</td>
					<td><input type="text" class="cls_sem" name="fim2_sem" id="fim2_sem" style="width:90%" title="2ª Semana fim" alt="integer"/></td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td align="center" style="width:50px">à</td>
					<td><input type="text" class="cls_sem" name="fim5_sem" id="fim5_sem" style="width:90%" title="5ª Semana fim" alt="integer"/></td>
				</tr>
			</table>
		</div>
	</fieldset>
