...
<body>
	<div id="border-top" class="h_blue">
		...
		<span class="title"><a href="#">ARS - NEO JURÍDICO</a></span>
	</div>
	<div id="content-box">
				...
				<div class="m wbg">
					...
					<div id="section-box">
						<div class="m">
							...
							<div id="alerta" style="display:<?php echo (isset($_GET['alerta']) && $_GET['alerta']==1?'':'none'); ?>;color:red;text-align:center" >Usuário ou senha inválidos!</div>
							<div class="clr"></div>
						</div>
					</div>
			...
			<noscript>
				Atenção! JavaScript deve estar habilitado para o bom funcionamento do backend do ***REMOVED***istrador.			
			</noscript>
	</div>
	<div id="footer">
		<p class="copyright">
			<a href="#">BVAA</a> - Desenvolvido por: @TTorres.</p>
	</div>
</body>
</html>
