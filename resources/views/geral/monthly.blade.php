...
<button type="submit" name="geral" value="1" formaction="relatorio" formtarget="" style="float:right; position:relative;margin-right:50px;border:1px dotted #999;">Mensal</button><br>
