@php
	...
	$arsTranslations = [
		...
		'Goal order updated successfully.' => __('Goal order updated successfully.'),
		'Error saving goal.' => __('Error saving goal.'),
		'Error saving goal order.' => __('Error saving goal order.'),
		...
		'Goal' => __('Goal'),
		'Order' => __('Order'),
		'Drag to reorder' => __('Drag to reorder'),
		'Drag and drop the rows to define the display order of the goals in this context.' => __('Drag and drop the rows to define the display order of the goals in this context.'),
