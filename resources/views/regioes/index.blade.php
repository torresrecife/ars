...
<script>
window.arsRegionResourceBaseUrl = "{{ url('admin/regioes') }}";
</script>
...
<div id="dialog-edit-regiao" title="Editar Regi&atilde;o" class="admin-dialog is-hidden">
	<p class="validateRegiao">Edite a Regi&atilde;o abaixo</p>
	<fieldset>
		<div>
			<table class="admin-dialog-table admin-dialog-table--region">
				<tr>
