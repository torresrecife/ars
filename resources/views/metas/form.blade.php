...
<div class="admin-page admin-page--flat metas-page">
	...
	<div class="admin-surface admin-surface--form">
		<form method="post" action="{{ $formAction }}" class="admin-form" id="meta-form">
			@csrf
			@if ($formMethod !== 'POST')
				@method($formMethod)
			@endif
			...
			<div class="metas-form-panel">
				<div class="metas-form-panel__header">
					...
					@if (!$isEditMode)
						<button type="button" class="admin-button admin-button--secondary" id="meta-add-row">{{ __('Add line') }}</button>
					@endif
				</div>
				...
				<div id="metas-rows" class="metas-rows">
					<div class="metas-row" data-row="1">
						<div class="metas-row__primary">
							<div class="admin-form-group metas-row__field metas-row__field--progress">
								<label for="meta_name_1">{{ __('Goal') }}</label>
								<select class="admin-form-input admin-form-select js-meta-type-source" name="meta_name_1" id="meta_name_1" data-row="1">
									<option value=""></option>
							...
							<div class="admin-form-group metas-row__field metas-row__field--region">
								<label for="regiao_id_1">{{ __('Region') }}</label>
								<select class="admin-form-input admin-form-select" name="regiao_id_1" id="regiao_id_1">
							...
							<div class="admin-form-group metas-row__field metas-row__field--value">
								<label for="meta_valor_1">{{ __('Total goal') }}</label>
								<input type="text" class="admin-form-input js-meta-total" name="meta_valor_1" id="meta_valor_1" value="{{ old('meta_valor_1', $goalRow['meta_valor_1']) }}" data-row="1" />
							</div>
							<div class="admin-form-group metas-row__field metas-row__field--manual">
						...
						<div class="metas-row__secondary">
							...
							<div class="admin-form-group metas-row__field metas-row__field--week js-meta-week-field" data-week="1">
								<label for="sem1_valor_1">{{ __('Week 1') }}</label>
								<input type="text" class="admin-form-input js-meta-week" name="sem1_valor_1" id="sem1_valor_1" value="{{ old('sem1_valor_1', $goalRow['sem1_valor_1']) }}" data-row="1" />
							</div>
							<div class="admin-form-group metas-row__field metas-row__field--week js-meta-week-field" data-week="2">
								<label for="sem2_valor_1">{{ __('Week 2') }}</label>
								<input type="text" class="admin-form-input js-meta-week" name="sem2_valor_1" id="sem2_valor_1" value="{{ old('sem2_valor_1', $goalRow['sem2_valor_1']) }}" data-row="1" />
							</div>
							<div class="admin-form-group metas-row__field metas-row__field--week js-meta-week-field" data-week="3">
								<label for="sem3_valor_1">{{ __('Week 3') }}</label>
								<input type="text" class="admin-form-input js-meta-week" name="sem3_valor_1" id="sem3_valor_1" value="{{ old('sem3_valor_1', $goalRow['sem3_valor_1']) }}" data-row="1" />
							</div>
							<div class="admin-form-group metas-row__field metas-row__field--week js-meta-week-field" data-week="4">
								<label for="sem4_valor_1">{{ __('Week 4') }}</label>
								<input type="text" class="admin-form-input js-meta-week" name="sem4_valor_1" id="sem4_valor_1" value="{{ old('sem4_valor_1', $goalRow['sem4_valor_1']) }}" data-row="1" />
							</div>
							<div class="admin-form-group metas-row__field metas-row__field--week js-meta-week-field" data-week="5">
								<label for="sem5_valor_1">{{ __('Week 5') }}</label>
								<input type="text" class="admin-form-input js-meta-week" name="sem5_valor_1" id="sem5_valor_1" value="{{ old('sem5_valor_1', $goalRow['sem5_valor_1']) }}" data-row="1" />
							</div>
							</div>
							@if (!$isEditMode)
								<div class="metas-row__actions">
									<button type="button" class="admin-button admin-button--secondary js-meta-remove-row is-hidden">{{ __('Remove') }}</button>
								</div>
							@endif
						</div>
					</div>
...
<div class="metas-row" data-row="__INDEX__">
	<div class="metas-row__primary">
		<div class="admin-form-group metas-row__field metas-row__field--progress">
			...
			<select class="admin-form-input admin-form-select js-meta-type-source" name="meta_name___INDEX__" id="meta_name___INDEX__" data-row="__INDEX__">
				<option value=""></option>
				@foreach ($andamentos as $andamento)
		...
		<div class="admin-form-group metas-row__field metas-row__field--region">
			...
			<select class="admin-form-input admin-form-select" name="regiao_id___INDEX__" id="regiao_id___INDEX__">
				@if ($allowGlobalRegion)
					<option value="">{{ __('All regions') }}</option>
				@endif
				@foreach ($regionsList as $region)
		...
		<div class="admin-form-group metas-row__field metas-row__field--value">
			...
			<input type="text" class="admin-form-input js-meta-total" name="meta_valor___INDEX__" id="meta_valor___INDEX__" value="" data-row="__INDEX__" />
		</div>
		<div class="admin-form-group metas-row__field metas-row__field--manual">
	...
	<div class="metas-row__secondary">
		...
		<div class="admin-form-group metas-row__field metas-row__field--week js-meta-week-field" data-week="1">
			...
			<input type="text" class="admin-form-input js-meta-week" name="sem1_valor___INDEX__" id="sem1_valor___INDEX__" value="" data-row="__INDEX__" />
		</div>
		<div class="admin-form-group metas-row__field metas-row__field--week js-meta-week-field" data-week="2">
			<label for="sem2_valor___INDEX__">{{ __('Week 2') }}</label>
			<input type="text" class="admin-form-input js-meta-week" name="sem2_valor___INDEX__" id="sem2_valor___INDEX__" value="" data-row="__INDEX__" />
		</div>
		<div class="admin-form-group metas-row__field metas-row__field--week js-meta-week-field" data-week="3">
			<label for="sem3_valor___INDEX__">{{ __('Week 3') }}</label>
			<input type="text" class="admin-form-input js-meta-week" name="sem3_valor___INDEX__" id="sem3_valor___INDEX__" value="" data-row="__INDEX__" />
		</div>
		<div class="admin-form-group metas-row__field metas-row__field--week js-meta-week-field" data-week="4">
			<label for="sem4_valor___INDEX__">{{ __('Week 4') }}</label>
			<input type="text" class="admin-form-input js-meta-week" name="sem4_valor___INDEX__" id="sem4_valor___INDEX__" value="" data-row="__INDEX__" />
		</div>
		<div class="admin-form-group metas-row__field metas-row__field--week js-meta-week-field" data-week="5">
			<label for="sem5_valor___INDEX__">{{ __('Week 5') }}</label>
			<input type="text" class="admin-form-input js-meta-week" name="sem5_valor___INDEX__" id="sem5_valor___INDEX__" value="" data-row="__INDEX__" />
		</div>
		</div>
		<div class="metas-row__actions">
			<button type="button" class="admin-button admin-button--secondary js-meta-remove-row">{{ __('Remove') }}</button>
		</div>
	</div>
</div>
</script>
