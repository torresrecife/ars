...
<div id="dialog-edit-cliente" title="{{ __('Edit Client') }}" class="admin-dialog is-hidden">
	<p class="validateTips">{{ __('Edit the client below') }}</p>
	<fieldset>
		<div id="tb_dialog" class="admin-dialog-panel">
			<table>
				<tr>
					<td>{{ __('Client Name') }}:<br><input type="text" class="cls_cliente admin-field--standard" name="banco_name" id="banco_name" value="" obrigatorio="1" title="{{ __('Client Name') }}" /></td>
					<td>{{ __('Code Text') }}<br><input type="text" class="cls_cliente admin-field--standard" name="banco_cod" id="banco_cod" value="" obrigatorio="1" title="{{ __('Code Text') }}" /></td>
				</tr>
				<tr>
					<td>{{ __('Sector') }}:<br>
				...
				<tr>
					<td>{{ __('Classification') }}:<br><input type="text" class="cls_cliente admin-field--standard" name="banco_class" id="banco_class" value="" obrigatorio="1" title="{{ __('Classification') }}" /></td>
					<td>{{ __('Simulator/Decision Deadline') }}:<br><input type="text" class="cls_cliente admin-field--standard" name="simulador" id="simulador" value="" obrigatorio="1" title="{{ __('Simulator/Decision Deadline') }}" /></td>
				</tr>
				<tr><td>{{ __('Short Name') }}:<br><input type="text" class="cls_cliente admin-field--standard" name="banco_curto" id="banco_curto" value="" obrigatorio="1" title="{{ __('Short Name') }}" /></td></tr>
				<tr>
